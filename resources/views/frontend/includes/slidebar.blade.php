<div class="slide-container" style="background-color: white; margin: 0 !important;">
    <div class="row g-0 align-items-start" style="height: 80vh;">
        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s" style="padding: 0;">
            <div class="image border" style="height: 80vh;">
                <img src="{{ asset('img/slide.jpeg') }}" class="img-fluid" alt="Creators India" style="width: 100%; height: 100%; object-fit: cover;">
            </div>
        </div>
