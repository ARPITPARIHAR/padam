...
<head>
    ...
    <!-- Favicons -->
    <link rel="shortcut icon" href="{{asset('userassets/img/logo.png')}}">
    <link rel="apple-touch-icon" href="{{asset('userassets/img/logo.png')}}">
...
if ($("#careerFile").length > 0) {}
    ...
    {{-- Expertise --}}
    <script src="{{asset('userassets/js/expertise.js')}}"></script>
    ...
    <script src="{{asset('userassets/js/home.js')}}"></script>
