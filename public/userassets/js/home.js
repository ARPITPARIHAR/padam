if ($("#indexFile").length > 0) {
  ...
  const page1Animations = () => {
    clutterAnimationWord(".page1-home-t1>h1");
    clutterAnimationWord(".page1-home-t2>h1");

    gsap.to(".page1-home-t1>h1>span", {
      color: "#fff",
      stagger: {
        amount: 0.8,
      },
  ...
  gsap.from(".coutner-elem2>h1", {
      ...
      onComplete: () => {
        counterNumberAnimation(".coutner-elem2>h1", 600, 50, "100+ Million");
      },
    });
  ...
  const allSlidersSwitch = () => {
    ...
    video.addEventListener("ended", () => {
      if (videoNumber === 0) {
        ...
        document.querySelector(".page1-home-text").style.opacity = 1;
        ...
        document.querySelector(".home-video").src = "/videos/for webite_panasonic.mp4";

        allSliders[0].style.backgroundColor = "#dfdfdf5f";
        allSliders[1].style.backgroundColor = "#dfdfdf5f";
        allSliders[2].style.backgroundColor = "#dfdfdf5f";
        allSliders[3].style.backgroundColor = "#dfdfdfec";
        document.querySelector(".page1-home-text").style.opacity = 0;
    ...
    const allSliders = document.querySelectorAll(".page1-home-sliders-tab");
