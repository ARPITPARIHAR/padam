if ($("#aboutFile").length > 0) {
  ...
  const page1Animations = () => {
    clutterAnimation(".page1-about-t2>h1");

    gsap.to(".page1-about-t2>h1>span", {
      color: "#fff",
      stagger: {
        amount: 0.8,
      },
  ...
  const textFillSection = () => {
    clutterAnimation(".text-about-fill>h1");

    gsap.to(".text-about-fill>h1>span", {
      color: "#000",
      stagger: 0.1,
      scrollTrigger: {
        trigger: ".text-about-fill",
        start: "top 50%",
        end: "top 0%",
        scrub: true,
        // markers: true,
  ...
  const codeDrop = () => {
    ...
    const prepareTextForAnimation = (itemElement) => {
      ...
      const textSpans = itemElement.querySelectorAll(".content__text-about > span");
    ...
    const fx1 = (itemElement, options) => {
      ...
      const imageElement = itemElement.querySelector(".content__img-about");
      const innerElements = imageElement.querySelectorAll(".content__img-inner-about"); // Now it selects both inners
      ...
      const tl = gsap
        ...
        .add(() => {
          ...
          innerElements[0].classList.toggle("content__img-inner--hidden-about");
          innerElements[1].classList.toggle("content__img-inner--hidden-about");
        })
        .to(imageElement, {
    ...
    const fx3 = (itemElement, options) => {
      ...
      const imageElement = itemElement.querySelector(".content__img-about");
      const innerElements = imageElement.querySelectorAll(".content__img-inner-about"); // Now it selects both inners
      const text = itemElement.querySelector(".content__text-about");
    ...
    const fx6 = (itemElement, options) => {
      ...
      // Select the elements to animate
      const imageElement = itemElement.querySelector(".content__img-about");
      const inner = imageElement.querySelector(".content__img-inner-about");
      const charsArray = prepareTextForAnimation(itemElement);
    ...
    preloadImages(".content__img-inner-about").then(() => {
